...
We can see in the bubble chart that some observations needed to be removed as part of data cleaning. The scope of this project nonetheless was to showcase the End-to-End pipeline process of a Data Engineering project.

...
def transform(df, *args, **kwargs):
    ...
    """
    # We will be followig the same order than in the Jupyter notebook for Transformation and Modeling operations. 
    # The only main difference is that we will omit creating auxiliar columns to rearrange their index columns.
    ...
    trip_distance_dim = trip_distance_dim[['trip_distance_id',
                                            'trip_distance']]
    ...
    datetime_dim = datetime_dim[['datetime_id', 'tpep_pickup_datetime', 'pickup_hour',
                                 ...
                                 'tpep_dropoff_datetime', 'dropoff_hour', 'dropoff_day',
